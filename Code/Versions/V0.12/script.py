...
class BasicExecute:
    ...
    def walkTree(self, node):
        ...
        if node[0]=='fun_def_ret':
            ...
            self.Asm.code = code
            self.Returnables[name]=self.walkTree(node[3])
            return self.Returnables[name]
        ...
        if node[0] == 'fun_call':
            ...
            try:
                ...
                if node[1] in self.Returnables:
                    return self.Returnables[node[1]]
        ...
        if node[0] in ('add','sub','mul'):
            ...
            if v1 and  node[2][0]!='tuple':
                if not v2 and val1[0]=='reg' or val1[0][3:]=='_reg_imm' or val1[0][3:]=="_reg_reg" or val1[0][3:]=="_reg_regx":
            ...
            if v2 and not node[1][0]=='tuple':
                if not v1 and val2[0]=='reg' or val2[0][3:]=='_reg_imm' or val2[0][3:]=="_reg_reg" or val2[0][3:]=="_reg_regx":
